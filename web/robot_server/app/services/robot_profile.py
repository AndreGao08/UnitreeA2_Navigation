...
class RobotProfileManager:
    ...
    PROFILES = {
        "unitree_a2": {
            ...
            "navigation_config": WORKSPACE_ROOT / "web/config/unitree_a2.yaml",
            "nav2_directory": WORKSPACE_ROOT / "web/config/nav2",
            "default_nav2_preset": "terrain",
            "behavior_tree_directory": WORKSPACE_ROOT / "web/config/behavior_trees",
